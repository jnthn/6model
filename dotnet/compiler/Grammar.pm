...
INIT {
    JnthnNQP::Grammar.O(':prec<y=>, :assoc<unary>', '%methodop');
    JnthnNQP::Grammar.O(':prec<x=>, :assoc<unary>', '%autoincrement');
    JnthnNQP::Grammar.O(':prec<w=>, :assoc<left>',  '%exponentiation');
    JnthnNQP::Grammar.O(':prec<v=>, :assoc<unary>', '%symbolic_unary');
    JnthnNQP::Grammar.O(':prec<u=>, :assoc<left>',  '%multiplicative');
    JnthnNQP::Grammar.O(':prec<t=>, :assoc<left>',  '%additive');
    JnthnNQP::Grammar.O(':prec<r=>, :assoc<left>',  '%concatenation');
    JnthnNQP::Grammar.O(':prec<m=>, :assoc<left>',  '%relational');
    JnthnNQP::Grammar.O(':prec<l=>, :assoc<left>',  '%tight_and');
    JnthnNQP::Grammar.O(':prec<k=>, :assoc<left>',  '%tight_or');
    JnthnNQP::Grammar.O(':prec<j=>, :assoc<right>', '%conditional');
    JnthnNQP::Grammar.O(':prec<i=>, :assoc<right>', '%assignment');
    JnthnNQP::Grammar.O(':prec<g=>, :assoc<list>, :nextterm<nulltermish>',  '%comma');
    JnthnNQP::Grammar.O(':prec<f=>, :assoc<list>',  '%list_infix');
    JnthnNQP::Grammar.O(':prec<e=>, :assoc<unary>', '%list_prefix');
}
